...
export const metadata: Metadata = {
  title: {
    absolute:
      'BESTER Telefonassistent Groitzsch & Leipzig – wenn Sie nach KI-Telefonassistenz, Telefonservice oder Anrufannahme in meiner Nähe suchen – Pixel Kraftwerk sorgt dafür, dass kein Anruf mehr verloren geht',
  },
