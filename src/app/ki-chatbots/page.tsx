...
export const metadata: Metadata = {
  title: {
    absolute:
      'BESTE KI-Chatbots Groitzsch & Leipzig – wenn Sie nach digitaler Kundenassistenz, Website-Chatbot oder KI-Chatbot in meiner Nähe suchen – Pixel Kraftwerk automatisiert Ihre Kundenanfragen zuverlässig',
  },
