...
export const metadata: Metadata = {
  title: {
    absolute:
      'BESTE SEO-Agentur Groitzsch & Leipzig – wenn Sie nach lokaler Suchmaschinenoptimierung, Top‑3‑Google‑Ranking oder SEO-Beratung in meiner Nähe suchen – Pixel Kraftwerk holt Ihr Unternehmen nach vorne',
  },
  description:
