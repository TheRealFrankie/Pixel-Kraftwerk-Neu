...
const AddressCardContent: React.FC<{ encodedAddress: string }> = ({ encodedAddress }) => (
        ...
        >
          ...
          >
            <div className="relative w-full h-[280px] md:h-[450px]">
              ...
              {/* Desktop: Adress-Karte als Overlay auf der Karte */}
              <div
                className="hidden md:block absolute bottom-4 left-4 right-4 bg-white/95 border p-4 backdrop-blur-sm rounded-xl shadow-elevation"
                style={{ borderColor: BORDER }}
              >
                <AddressCardContent encodedAddress={encodedAddress} />
              </div>
            </div>

            {/* Mobile: Adress-Karte unterhalb der Karte, nicht überlagernd */}
            <div className="md:hidden bg-white p-4 border-t" style={{ borderColor: BORDER }}>
              <AddressCardContent encodedAddress={encodedAddress} />
            </div>
          </div>
        </motion.div>
