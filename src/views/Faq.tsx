    ...
    <div className="pt-24" style={{ background: '#FAFAF9', minHeight: '100vh' }}>
      ...
      <div className="container mx-auto px-6 md:px-12 py-24">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="mb-12 text-center text-base leading-relaxed" style={{ color: '#404B48' }}>
          ...
          {/* Regular FAQ Section */}
          <h2 className="text-2xl font-heading font-bold mb-8" style={{ color: '#0C1210' }}>
          ...
          <div className="space-y-6 mb-20">
            <div className="border-l-4 border-primary-500 pl-6 py-4">
              <div className="flex items-start mb-4">
                ...
                <h3 className="text-lg font-heading font-bold" style={{ color: '#0C1210' }}>
                  Wie individuell sind die KI-Lösungen wirklich?
                </h3>
              </div>
              <p className="text-sm leading-relaxed ml-8" style={{ color: '#404B48' }}>
          ...
          <div className="rounded-2xl border bg-white p-8 shadow-card" style={{ borderColor: '#E4E9E7' }}>
            <h2 className="text-2xl font-heading font-bold mb-8 text-center" style={{ color: '#0E7C72' }}>
              Weitere wichtige Informationen
            </h2>

            <div className="space-y-4">
              <div className="rounded-xl border p-5" style={{ borderColor: '#E4E9E7' }}>
                <h3 className="text-base font-heading font-bold mb-2 flex items-start gap-2" style={{ color: '#0C1210' }}>
                  <span className="flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold" style={{ background: 'rgba(14,124,114,0.08)', color: '#0E7C72' }}>?</span>
