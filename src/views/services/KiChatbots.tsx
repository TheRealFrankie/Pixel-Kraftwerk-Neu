            ...
            <div>
              ...
              >
                ...
                <div className="flex items-center gap-4 sm:hidden">
                  ...
                  <a href={`tel:${businessInfo.contact.telephoneE164}`} className="text-sm font-semibold underline underline-offset-4" style={{ color: '#0E7C72' }}>
                    Jetzt anrufen
                  </a>
                </div>
                ...
                <a href={`tel:${businessInfo.contact.telephoneE164}`} className="btn-secondary hidden sm:inline-flex">
